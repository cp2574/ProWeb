				...
				if (this.settings[extensionName]) {
					...
					if (typeof oursettings !== 'function') {
						...
						oursettings = function(){
							...
							//var undoButtonSytle = 'position:absolute;display:none;margin:0 !important;top:auto left:10%'
                            var undoButtonSytle = 'position:absolute;display:none;margin:0 !important;top:auto '
                                , $undoButton = $('<input type="button" value="back" class="btn btn-info" style="'+undoButtonSytle+'" />')
